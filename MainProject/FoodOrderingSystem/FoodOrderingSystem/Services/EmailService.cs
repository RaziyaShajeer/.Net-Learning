	...
	public class EmailService
	{
		...
		public async Task SendEmailAsync(string name, string emailAddress, string password)
		{
			try {
				...
				email.Subject = "Logins for Food Ordeing system";
				var builder = new BodyBuilder();
				email.Body = new TextPart(MimeKit.Text.TextFormat.Html)
				{
					Text = $@"
        Hi {name},<br><br>
        Your credentials to the Food Ordering System are:<br>
        ...
        Please log in and change your password after your first login."
				...
				smtp.Connect(_mailSettings.Host, _mailSettings.Port, MailKit.Security.SecureSocketOptions.SslOnConnect);
